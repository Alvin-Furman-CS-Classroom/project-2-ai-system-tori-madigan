"""
Integration test for Module 1 -> Module 2 -> Module 3 -> Module 4 -> Module 5 -> Module 6.
"""
...
from module6_knowledge_representation import module1_2_3_5_to_module6  # noqa: E402
...
def test_full_pipeline_to_module6(grid_size: int, difficulty: str, seed: int):
    ...
    module6_report = module1_2_3_5_to_module6(module3_output, module2_kb, puzzle_data, module5_report)

    assert "=== SOLUTION EXPLANATION ===" in module6_report
    assert "OVERALL STRATEGY" in module6_report
    assert "REASONING PHASES" in module6_report
    assert "EXPLANATION METADATA" in module6_report
